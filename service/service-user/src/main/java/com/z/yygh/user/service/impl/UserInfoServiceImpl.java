package com.z.yygh.user.service.impl;
...
import com.z.yygh.enums.AuthStatusEnum;
import com.z.yygh.model.user.Patient;
import com.z.yygh.model.user.UserInfo;
import com.z.yygh.user.mapper.UserInfoMapper;
...
public class UserInfoServiceImpl extends
    ...
    public Map<String, Object> loginUser(LoginVo loginVo) {
        ...
        if(!StringUtils.isEmpty(loginVo.getOpenid())) {
            userInfo = this.selectWxInfoOpendId(loginVo.getOpenid());
            if(null != userInfo) {
    ...
    @Override
    public UserInfo selectWxInfoOpendId(String openid) {
