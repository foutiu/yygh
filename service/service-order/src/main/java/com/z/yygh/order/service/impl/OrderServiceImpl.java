...
import com.z.common.rabbit.constant.MqConst;
import com.z.common.rabbit.service.RabbitService;
...
import com.z.yygh.order.mapper.OrderMapper;
import com.z.yygh.order.service.OrderService;
import com.z.yygh.order.service.WeixinService;
import com.z.yygh.user.client.PatientFeignClient;
import com.z.yygh.vo.hosp.ScheduleOrderVo;
import com.z.yygh.vo.msm.MsmVo;
import com.z.yygh.vo.order.*;
...
//获取就诊人信息
    ...
    public Object cancelOrder(Long orderId) {
        ...
        OrderInfo orderInfo = baseMapper.selectById(orderId);
        //判断是否可以取消
        DateTime quitting = new DateTime(orderInfo.getQuitTime());
        if(quitting.isBeforeNow()){
