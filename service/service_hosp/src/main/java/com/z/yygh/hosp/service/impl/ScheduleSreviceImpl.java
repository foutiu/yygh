...
import com.z.yygh.hosp.mapper.ScheduleMapper;
import com.z.yygh.hosp.repository.ScheduleRepository;
 ...
 */
@Service
public class ScheduleSreviceImpl extends ServiceImpl<ScheduleMapper,Schedule> implements ScheduleSrevice {
    ...
    public Map<String, Object> getBookingScheduleRule(Integer page, Integer limit, String hoscode, String depcode) {
        ...
        if(null == hospital){
            new YyghException(ResultCodeEnum.DATA_ERROR );
        }
